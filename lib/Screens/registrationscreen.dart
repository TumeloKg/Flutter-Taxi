import 'package:Taxi/Screens/loginscreen.dart';
...
class RegistrationScreen extends StatelessWidget {
                    ...
                    RaisedButton(
                      ...
                      onPressed: () {
                        if (nameTextEditingController.text.length < 3) {
                          ...
                          displayToastMessage(
                              "Enter valid Valid Phone Number.", context);
  ...
  void registerNewUser(BuildContext context) async {
    ...
    if (firebaseUser != null) //user created
    {
      ...
      displayToastMessage("New User Account was not been Created.", context);
    }
  }
}

//golbal function for displaying toast msg
